export default function Hero() {
    return (
        <section className="min-h-screen py-24 md:px-14 px-12 md:pt-0 grid grid-cols-1 md:grid-cols-2 align-baseline snap-start">
            ...
            <div className="flex justify-center items-center px-0 md:px-12 py-0 mt-4 md:mt-0 md:py-24" data-aos={"zoom-in"}>
                <iframe className="w-full h-full" src="https://www.youtube.com/embed/aCn8cPgRFHY" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
            </div>
        </section>
    )
}